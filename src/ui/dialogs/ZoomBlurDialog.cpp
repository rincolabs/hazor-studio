#include "ZoomBlurDialog.hpp"
#include "ParamRow.hpp"

#include <QVBoxLayout>

ZoomBlurDialog::ZoomBlurDialog(ToolDialog::Mode mode, QWidget* parent)
    : ToolDialog(tr("Zoom Blur"), mode, parent)
{
...
QVariantMap ZoomBlurDialog::collectParams() const
{
    return {
...
void ZoomBlurDialog::onAnyChanged()
{
    markParamChanged();
}
